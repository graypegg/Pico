module Errors (showError, showSuccess) where
import Types
...
-- | Shows a nice looking success message
showSuccess :: String -> String
showSuccess msg = ("\x1b[30;42m"++(getDashes True (msg'!!0))++"-Success!-"++(getDashes False (msg'!!0))++"\x1b[0m\n\x1b[32;40m"++(msg'!!0)++"\x1b[0m\n"++(init (unlines (drop 1 msg')))++"\x1b[0m")
				where msg' = lines msg
